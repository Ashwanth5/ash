...
<form action="{{ route('profile.upload') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="upload-container">
        <label for="profile_picture" class="upload-label">
            <img src="{{ asset('storage/uploads/10.jpg') }}" alt="Profile" class="profile-pic">
            <input type="file" id="profile_picture" name="profile_picture" class="upload-input" accept="image/*">
        </label>
    </div>
